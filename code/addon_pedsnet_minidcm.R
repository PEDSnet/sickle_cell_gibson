...
personal_tables <- function() {
  tribble( ~tbl_expr, ~cleanup_name, ~indexes, ~output_name,
          ...
          'measurement',
          cdm_tbl('measurement_labs'), NA,
          list('person_id','measurement_id', 'measurement_concept_id'),
          'measurement_labs',
          cdm_tbl('measurement_organism'), NA,
          list('person_id','measurement_id', 'visit_occurrence_id', 'organism_concept_id'),
          'measurement_organism',
          cdm_tbl('measurement_vitals'), NA,
          list('person_id','measurement_id', 'visit_occurrence_id'),
          'measurement_vitals',
          ...
          'visit_occurrence', 
          cdm_tbl('specimen'), NA,
          list('person_id','specimen_id', 'specimen_concept_id'),
          'specimen')
}
...
impersonal_tables <- function() {
   tribble( ~tbl_expr, ~cleanup_name, ~indexes, ~output_name, ~join_on,
           ...
           cdm_tbl('condition_occurrence_concept_name'), NA, list('condition_concept_id', 'condition_concept_name'),
            'condition_occurrence_concept_name', 'condition_concept_id', 
           cdm_tbl('drug_exposure_concept_name'), NA, list('drug_concept_id', 'drug_concept_name'),
            'drug_exposure_concept_name', 'drug_concept_id', 
            cdm_tbl('measurement_concept_name'), NA, list('measurement_concept_name', 'measurement_concept_id'),
            'measurement_concept_name', 'measurement_concept_id', 
            cdm_tbl('procedure_occurrence_concept_name'), NA, list('procedure_concept_name', 'procedure_concept_id'),
            'procedure_occurrence_concept_name', 'procedure_concept_id')
}
